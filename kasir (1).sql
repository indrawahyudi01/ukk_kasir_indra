...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Feb 2024 pada 01.14
...
(11, '2024-02-28', 10000.00, 2802071600);
...
(11, 'Kaca Mata', 10000.00, 10),
(12, 'Maulana Malik Ibrahim', 21452651.00, 0);
...
--
ALTER TABLE `pelanggan`
  MODIFY `id_pelanggan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2802071601;

--
-- AUTO_INCREMENT untuk tabel `penjualan`
--
ALTER TABLE `penjualan`
  MODIFY `id_penjualan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
